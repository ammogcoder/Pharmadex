...
import org.msh.pharmadex.service.ImageCombinerService;
...
public class ReviewDetailBn implements Serializable {
	...
	@ManagedProperty(value = "#{imageCombinerService}")
    private ImageCombinerService imageCombinerService;
    ...
    public void handleFileUpload(FileUploadEvent event) {    	
    	...
    	if(fname.toLowerCase().endsWith(".bmp")){
    		 FacesMessage message = new FacesMessage(bundle.getString("global_fail") + " " + bundle.getString("error_bmpFile") + " (" + fname + ")");
    		 message.setSeverity(FacesMessage.SEVERITY_ERROR);
    	     FacesContext.getCurrentInstance().addMessage(null, message);
    	}else{
    		FacesMessage message = new FacesMessage("Successful", fname + " is uploaded.");
            FacesContext.getCurrentInstance().addMessage(null, message); 
            reviewDetail.setFile(imageCombinerService.combiner(reviewDetail.getFile(), event.getFile().getContents()));
	...
	public ImageCombinerService getImageCombinerService() {
		return imageCombinerService;
	}

	public void setImageCombinerService(ImageCombinerService imageCombinerService) {
